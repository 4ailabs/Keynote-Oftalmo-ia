...
export const Footer: React.FC = () => {
    return (
        <footer className="py-4 sm:py-6 text-center border-t border-zinc-800/50 mt-8 sm:mt-12 pb-20 sm:pb-6">
            <div className="container mx-auto px-4">
                <div className="space-y-2">
                    <p className="text-xs sm:text-sm text-zinc-600 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
                        ...
                        <a href="https://4ailabs.vercel.app" target="_blank" rel="noopener noreferrer" className="text-blue-400 font-medium hover:text-blue-300 transition-colors duration-200 flex items-center gap-1 min-h-[44px] sm:min-h-0">
